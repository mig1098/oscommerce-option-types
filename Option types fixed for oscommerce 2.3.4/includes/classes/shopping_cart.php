          ...
          if (!tep_db_num_rows($product_query)) {
            ...
            if (isset($this->contents[$products_id]['attributes'])) {
              ...
              while (list($option, $value) = each($this->contents[$products_id]['attributes'])) {
                //tep_db_query("insert into " . TABLE_CUSTOMERS_BASKET_ATTRIBUTES . " (customers_id, products_id, products_options_id, products_options_value_id) values ('" . (int)$customer_id . "', '" . tep_db_input($products_id) . "', '" . (int)$option . "', '" . (int)$value . "')");//original
//BOF - Zappo - Option Types v2 - Update query to include attribute value             
...
//EOF - Zappo - Option Types v2 - Update query to include attribute value
              }
            }
          } else {
